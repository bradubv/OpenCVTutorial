...
//	}
    ...
    private void approxPolys(ArrayList<MatOfPoint> contours, ArrayList<MatOfPoint2f> polys) {
		//for each contour detected approximate polygon to reduce the number of vertices
...
//		int retCode;
//		
//		//if we have more than three shapes something went wrong with the filtering
//		if (contours.size() < 3) {
//			
//			retCode = 0;
//		} else {
